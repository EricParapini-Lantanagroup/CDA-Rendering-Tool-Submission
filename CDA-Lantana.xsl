...
<!-- 
  ...
  This style sheet is based off the original CDA XSL, which was made possible thanks to the contributions of:
  - Jingdong Li
  - KH
  - Rick Geimer
  - Sean McIlvenna
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="make-tableofcontents">
    <nav class="cda-render bs-docs-sidebar hidden-print hidden-xs hidden-sm affix toc-box" id="navbar-cda">
      <ul class="cda-render nav nav-stacked fixed">
        <li>
        ...
        <li>
          <a class="cda-render lantana-toc" href="#emergency-contact">EMERGENCY CONTACT</a>
        </li>
        <li>
  ...
  <xsl:template name="componentOf">
    <xsl:if test="n1:componentOf/n1:encompassingEncounter">
      <div class="header container-fluid">
  ...
  <xsl:template name="section-title">
    ...
    <a class="section-title" id="{generate-id($title)}" ng-click="gotoAnchor('toc')">
      <xsl:value-of select="$title"/>
    </a>
  </xsl:template>
